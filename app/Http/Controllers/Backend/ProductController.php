...
class ProductController extends Controller
{
    ...
    public function StoreProduct(Request $request)
    {
        ...
        foreach ($images as $img) {
            ...
            Image::make($img)->resize(917, 1000)->save('upload/products/multi-image/' . $img_name);
            $upload_pth = 'upload/products/multi-image/' . $img_name;
            MultiImg::insert([
                'product_id' => $product_id,
                'photo_name' => $upload_pth,
                'created_at' => Carbon::now()
            ]);
        }
        $notification = [
    ...
    public function ProductEdit($id)
    {
        ...
        return view('backend.product.product_edit', compact('product', 'subcategory', 'categories', 'subsubcategory', 'multiImages', 'brands'));
    }
    ...
    public function ThambnailImageUpdate(Request $request)
    {
        ...
        Image::make($image)->resize(917, 1000)->save('upload/products/multi-image/' . $make_gen);
        $uploadPath = 'upload/products/multi-image/' . $make_gen;
