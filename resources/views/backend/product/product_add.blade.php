                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_tags_en" class="form-control"
                                                            required value="Lorem,Ipsum,Amet" data-role="tagsinput">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_size_en" class="form-control"
                                                            required value="Small,Midium,Large" data-role="tagsinput">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_color_en" class="form-control"
                                                            required value="red,Black,Amet" data-role="tagsinput">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_color_hin" class="form-control"
                                                            required value="red,Black,Large" data-role="tagsinput">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="file" name="product_thambnail" class="form-control"
                                                            required onChange="mainThamUrl(this)">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="editor2" name="long_descp_hin" rows="10" cols="80" required>Long Description Hindi</textarea>
                                                    </div>
                                                </div>
                                            </div> <!-- end col md 6 -->
                                        </div> <!-- end 8th row  -->
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            $('select[name="subsubcategory_id"]').append('<option value="' +
                                value.id + '">' + value.subsubcategory_name_en + '</option>'
                            );
                        });
                    },
                });
