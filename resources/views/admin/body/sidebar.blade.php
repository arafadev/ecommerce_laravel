    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ $prefix == '/coupons' ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ $route == 'manage-coupon' ? 'active' : '' }}"><a
                            href="{{ route('manage-coupon') }}"><i class="ti-more"></i>Manage Coupons</a>
                    </li>
                </ul>
            </li>
            <li class="treeview {{ $prefix == '/shipping' ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ $route == 'manage-division' ? 'active' : '' }}"><a
                            href="{{ route('manage-division') }}"><i class="ti-more"></i>Ship Division</a>
                    </li>
                    ...
                    <li class="{{ $route == 'manage-state' ? 'active' : '' }}"><a
                            href="{{ route('manage-state') }}"><i class="ti-more"></i>Ship Status</a>
                    </li>
            ...
            <li class="treeview {{ $prefix == '/slider' ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'manage-slidre' ? 'active' : '' }}"><a
